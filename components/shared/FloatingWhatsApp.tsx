...
export function FloatingWhatsApp() {
  ...
  // Hide the FAB when the footer enters the viewport so it doesn't sit on
  // top of the footer's social icons / contact links.
  useEffect(() => {
  ...
  return (
    <a
      ...
      tabIndex={hidden ? -1 : 0}
      className={cn(
        "group fixed bottom-5 right-5 md:bottom-7 md:right-7 z-40 flex items-center gap-3 transition-all duration-300",
        hidden

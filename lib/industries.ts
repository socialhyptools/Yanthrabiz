...
export const industries: IndustryMeta[] = [
  {
    ...
    short: "Agriculture",
    tagline: "Tractors, harvesters, rotavators, seed drills — for farms of every scale.",
    icon: Wheat,
  ...
  },
  {
    ...
    short: "Paper",
    tagline: "Paper making, cutting, printing, and recycling lines for every output.",
    icon: FileText,
  ...
  },
  {
    ...
    short: "Pharma",
    tagline: "Tablet, capsule, liquid filling and blister packing for pharma production.",
    icon: Pill,
  ...
  },
  {
    ...
    short: "Hospital",
    tagline: "Diagnostic, surgical, monitoring, and patient-care equipment, verified.",
    icon: Stethoscope,
  ...
  },
  {
    ...
    short: "Leather",
    tagline: "Cutting, splitting, buffing and stitching machines for leather goods.",
    icon: Layers3,
  ...
  },
  {
    ...
    short: "Plastic",
    tagline: "Injection molding, extrusion, blow molding, and recycling lines.",
    icon: Container,
  ...
  },
  {
    ...
    short: "Food & Beverage",
    tagline: "Mixing, cutting, beverage processing, and packaging for F&B units.",
    icon: Utensils,
  ...
  },
  {
    ...
    short: "Chemical",
    tagline: "Mixing, reactor, filling, and storage systems for chemical plants.",
    icon: FlaskConical,
  ...
  },
  {
    ...
    short: "Industrial",
    tagline: "Manufacturing, processing, packaging, and material handling at scale.",
    icon: Factory,
  ...
  },
  {
    ...
    short: "Miscellaneous",
    tagline: "Utility, workshop, support and multi-purpose machines for any unit.",
    icon: Wrench,
